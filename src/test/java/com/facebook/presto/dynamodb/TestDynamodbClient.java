...
public class TestDynamodbClient
{
    ...
    public void testMetadata()
            throws Exception
    {
        URL metadataUrl = Resources.getResource(TestDynamodbClient.class, "/example-data/example-metadata.json");
        ...
        DynamodbTable table = client.getTable("numbers");
        assertNotNull(table, "table is null");
        assertEquals(table.getName(), "numbers");
//        assertEquals(table.getColumns(), ImmutableList.of(new DynamodbColumn("text", createUnboundedVarcharType()), new DynamodbColumn("value", BIGINT)));
