...
public class TestDynamodbRecordSet
{
    private URI dataUri;
    ...
    public void testGetColumnTypes()
            throws Exception
    {
        RecordSet recordSet = new DynamodbRecordSet(new DynamodbSplit("connectorId", "tableName", null, null),
                ImmutableList.of(
                new DynamodbColumnHandle("test", "text", createUnboundedVarcharType(), 0),
                new DynamodbColumnHandle("test", "value", BIGINT, 1)), null);
        assertEquals(recordSet.getColumnTypes(), ImmutableList.of(createUnboundedVarcharType(), BIGINT));

        recordSet = new DynamodbRecordSet(new DynamodbSplit("connectorId", "tableName", null, null), ImmutableList.of(
                new DynamodbColumnHandle("test", "value", BIGINT, 1),
                new DynamodbColumnHandle("test", "text", createUnboundedVarcharType(), 0)), null);
        ...
        recordSet = new DynamodbRecordSet(new DynamodbSplit("connectorId", "tableName", null, null), ImmutableList.of(), null);
    ...
    public void testCursorSimple()
            throws Exception
    {
        RecordSet recordSet = new DynamodbRecordSet(new DynamodbSplit("connectorId", "tableName", null, null), ImmutableList.of(
                new DynamodbColumnHandle("test", "text", createUnboundedVarcharType(), 0),
                new DynamodbColumnHandle("test", "value", BIGINT, 1)), null);
